...
flowchart LR
    subgraph clients["Trusted clients"]
        ...
        macbook["MacBook<br/>10.8.0.11/32 direct<br/>10.8.0.31/32 relay"]
        ...
        iphone["iPhone<br/>10.8.0.21/32 direct<br/>10.8.0.32/32 relay"]
    end
...
| MacBook | `10.8.0.11/32` direct; `10.8.0.31/32` Alpha relay | Runtime and VPS persistence verified; Mac reboot activation pending |
...
| iPhone | `10.8.0.21/32` direct; `10.8.0.32/32` Alpha relay | Runtime identity rotation and private-service access verified 2026-07-24; obsolete peer cleanup and updated persistent-file proof pending |
...
| --- | --- | --- |
| MacBook | `10.8.0.11/32` | `10.8.0.31/32` |
| iPhone | `10.8.0.21/32` | `10.8.0.32/32` |
...
They use `10.8.0.32/32` for the iPhone and `10.8.0.31/32` for the MacBook, and connect to Alpha
