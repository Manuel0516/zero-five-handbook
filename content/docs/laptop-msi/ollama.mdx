...
flowchart LR
    ...
    router --> msi["MSI Ollama<br/>10.8.0.12:11434<br/>planned"]
```
...
MSI's UFW permits TCP `11434` only on `wg0` from Alpha's `10.8.0.1/32` source:
...
This is required for the Alpha personal-ai router; the Ollama port remains
closed on the LAN and public interfaces.
