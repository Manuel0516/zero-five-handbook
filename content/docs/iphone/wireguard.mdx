...
The iPhone is deployed as `10.8.0.10/32`. Its WireGuard peer advertises only
...
- `wg0` was up at `10.8.0.1/24`, with the route to `10.8.0.10`;
...
`10.8.0.10/32`. Toggling the tunnel restored connectivity, and the owner
