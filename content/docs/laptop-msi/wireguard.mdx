...
`zero-five-infra`. Its address is `10.8.0.12/32`. It has three WireGuard
peers: Alpha at `10.8.0.1`, Delta at `10.8.0.2`, and **Gamma at `10.8.0.3`
...
flowchart LR
    ...
    msi -->|"Direct peer<br/>10.8.0.2/32"| delta["Delta Raspberry Pi<br/>10.8.0.2/32<br/>UDP 51820"]
    msi <-->|"Mutual peer<br/>10.8.0.3/32<br/>LAN 192.168.1.110:51820 ⇄ .107:51820"| gamma["Gamma<br/>10.8.0.3/32<br/>AI host"]
    gamma -->|"Ollama 10.8.0.12:11434"| msi
```
...
1. **Delta peer endpoint → LAN IP.** The home router's hairpin NAT is broken
   ...
   via AdGuard (`10.8.0.2`) broke. Fix: `Endpoint = 192.168.1.106:51820`.
...
2. **Gamma mutual peer** (default port 51820, LAN endpoint `192.168.1.107`),
   ...
   `10.8.0.3/32` in addition to `10.8.0.1/32` (alpha).
