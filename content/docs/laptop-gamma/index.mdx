...
```mermaid
flowchart LR
    mac["MacBook<br/>192.168.1.157<br/>WireGuard 10.8.0.11"]
    alpha["Alpha VPS<br/>Public SSH :2020<br/>WireGuard 10.8.0.1"]
    gamma["Gamma<br/>LAN 192.168.1.107<br/>WireGuard 10.8.0.3"]

    mac -->|"SSH alias: delta"| delta["Delta Raspberry Pi<br/>WireGuard 10.8.0.2"]
    delta -->|"ProxyJump second hop<br/>10.8.0.3:22"| gamma
...
| WireGuard | `wg0` at `10.8.0.3/32`; `wg-quick@wg0` enabled and active |
| VPN proof | Gamma pinged Alpha at `10.8.0.1`; Alpha pinged Gamma at `10.8.0.3` |
