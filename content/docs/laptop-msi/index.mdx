...
flowchart LR
    ...
    gamma["Gamma<br/>10.8.0.3<br/>AI host"]
    ...
    msi <-->|"mutual WG peer<br/>10.8.0.12 ⇄ 10.8.0.3<br/>LAN 51820"| gamma
    msi -->|"Ollama 10.8.0.12:11434<br/>deepseek-r1:7b, qwen2.5-coder:7b"| router
    gamma --> router
    router --> webui
    webui -. "Traefik on Alpha" .-> alpha
    msi -->|"peer 10.8.0.12"| alpha
    mac -->|"local network"| localdrop
    msi -->|"local network"| localdrop
```

The MSI is a personal Linux desktop **and a live AI backend**. It runs
Ollama (`10.8.0.12:11434`) with `deepseek-r1:7b` and `qwen2.5-coder:7b`, and
