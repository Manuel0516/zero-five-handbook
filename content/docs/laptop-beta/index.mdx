...
flowchart LR
    ...
    mac -->|"SSH alias delta<br/>WireGuard 10.8.0.2"| delta["Delta Raspberry Pi"]
    delta -->|"ProxyJump second hop<br/>10.8.0.4:22"| beta
    beta -->|"WireGuard client<br/>10.8.0.4/32"| alpha
...
| WireGuard | Beta `wg0` at `10.8.0.4/32`; boot persistence, recent handshake, bidirectional ping, and private Handbook access verified after reboot |
