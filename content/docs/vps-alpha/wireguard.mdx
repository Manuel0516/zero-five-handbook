...
flowchart LR
    subgraph clients["Trusted clients"]
        ...
        gamma["Gamma<br/>10.8.0.4/32<br/>Runtime and persistence verified"]
        beta["Beta laptop / Proxmox<br/>10.8.0.5/32<br/>Runtime verified"]
        ...
        iphone["iPhone<br/>10.8.0.10/32<br/>Runtime restored 2026-07-24"]
    end
...
| Gamma | `10.8.0.4/32` | Alpha path verified; Delta peer, direct ping, and Delta→Gamma SSH verified 2026-08-13; Gamma reboot persistence pending |
| Beta | `10.8.0.5/32` | Beta reboot persistence, handshake, bidirectional ping, Handbook access, Alpha-to-Proxmox access, and Mac SSH jump verified 2026-07-22; Alpha peer owner-applied and Alpha reboot proof pending |
| iPhone | `10.8.0.10/32` | Runtime identity rotation and private-service access verified 2026-07-24; obsolete peer cleanup and updated persistent-file proof pending |
...
> The route was corrected to the modeled `10.8.0.10/32`, the complete file was
