...
flowchart LR
    subgraph clients["Trusted clients"]
        ...
        iphone["iPhone<br/>10.8.0.10/32<br/>Runtime verified 2026-07-21"]
    end
...
| iPhone | `10.8.0.10/32` | Persistent route and recent handshake verified in the 2026-07-21 Alpha audit |
...
| `wireguard/iphone.conf.example` | Planned iPhone interface and VPS-only peer |
