...
flowchart LR
    ...
    msi -->|"planned/narrow peer<br/>10.8.0.2"| alpha
    alpha -->|"VPN-only Ollama path<br/>10.8.0.2:11434"| msi
...
of a second AI backend: the VPS router can reach `10.8.0.2:11434` over
...
| [WireGuard](/docs/laptop-msi/wireguard) | The legacy `cachyos-laptop` peer, narrow routing, verification, and rollback |
