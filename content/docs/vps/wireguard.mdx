...
stable public hub; the CachyOS laptop and MacBook connect to it as clients, and
an iPhone peer is reserved but not yet deployed.
...
flowchart LR
    subgraph clients["Trusted clients"]
        ...
        iphone["iPhone<br/>10.8.0.10/32<br/>Deployment pending"]
    end
...
| iPhone | `10.8.0.10/32` | Configuration recorded; key generation, deployment, and runtime verification pending |
